...
const Hero = () => {
  return (
    <main
      id="hero-id"
      className="w-[100vw] h-[calc(100vh-100px)] flex items-center justify-center z-[-1] relative shadow-2xl "
    >
      <div
        id="hero-elements-container"
        className="flex flex-col lg:flex lg:flex-row items-center justify-center max-w-[100%] w-full max-h-[100%] py-9 gap-5  "
      >
        <img
        ...
        <div className="w-full lg:w-[55%] flex flex-col justify-around items-center text-center">
          ...
          <h2 className="text-2xl text-white border-black p-1.5 rounded-xl">
            I'm your new FullStack Developer!
          </h2>
          <Icons />
        </div>
      </div>
